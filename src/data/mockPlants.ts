...
export const mockPlants: Plant[] = [
  ...
  },
  {
    ...
    name: "Dracaena",
    emoji: "🌴",
    nextWatering: new Date(Date.now() + 1000 * 60 * 60 * 24 * 11),
    wateringInterval: 14,
    lastWatered: new Date(Date.now() - 1000 * 60 * 60 * 24 * 3),
    missedWatering: false,
    notes: "",
  ...
  },
  {
    ...
    replantingInterval: 18,
    nextReplanting: new Date(Date.now() + 1000 * 60 * 60 * 24 * 280),
    autoSchedule: true,
  },
  {
    id: "20",
    ...
    notes: "",
    replantingInterval: 12,
    nextReplanting: new Date(Date.now() + 1000 * 60 * 60 * 24 * 80),
    autoSchedule: false,
  },
  {
    id: "21",
    ...
    notes: "Wax plant",
    replantingInterval: 36,
    nextReplanting: new Date(Date.now() + 1000 * 60 * 60 * 24 * 700),
    autoSchedule: true,
  },
  {
    id: "22",

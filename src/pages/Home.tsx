...
const PageHome = () => {
  ...
  return (
    <PageTransition>
      <div className="fixed top-6 left-6 right-6 z-40 flex items-center justify-end">
        <button
          type="button"
      ...
      <div className="min-h-screen bg-background px-6 py-10 flex flex-col items-center justify-center">
        <div className="w-full max-w-md mx-auto">
          <div className="flex flex-col items-center">
            <HomeIcon />
            <h1 className="mt-1 text-[30px] font-title font-bold text-foreground">Planty</h1>
            <p className="-mt-1 text-[16px] text-muted-foreground text-center">Treat your plants the way they deserve</p>
          </div>
          ...
          {/* Terms/Policy moved to fixed bottom bar (24px from bottom) */}
        </div>
      </div>
